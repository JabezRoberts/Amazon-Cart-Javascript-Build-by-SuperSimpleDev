...
*/
// Create a variable to track whether or not we are playing then use this variable to stop the auto playing
...
function autoPlay() { // prefer this to the arrow function above because it is easier to read and allows hoisting meaning you can call it before it's defined
    if (!isAutoPlaying) {
        ...
        isAutoPlaying = true;
    } else { // use this branch to stop auto playing. do this by setInterval returning a number or interval ID we can use to stop the interval. now to stop the function from auto running use clearInterval()
